...
namespace QLBThuocc
{
    public partial class FrmBCHT_theo_kho : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            FrmrptBCHT_theokh f = new FrmrptBCHT_theokh(bc);
            f.Show();
            txtMakho.Text = " ";
            NapMakho();
        }
        ...
        private void FrmBCHT_theo_kho_Load(object sender, EventArgs e)
        {
